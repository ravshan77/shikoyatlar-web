...
export const EditComplaintPage: React.FC = () => {
  ...
  const [mode, setMode] = useState<'edit' | 'view'>(urlMode === 'view' ? 'view' : 'edit');
  ...
  const isReadOnly = mode === 'view' || isCompleted;
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  {isReadOnly ? 'Shikoyatni ko\'rish' : 'Shikoyatni tahrirlash'}
                </h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
        <div className="flex items-center space-x-4">
          ...
          {/* Creation Date */}
          <span className="text-sm text-gray-500">
            Yaratilgan: {new Date(complaint.created_at).toLocaleString('uz-UZ')}
          </span>
        </div>
      </div>
              ...
              <div>
                ...
                {images.length > 0 ? (
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                    ...
                    <p className="text-gray-600">Hech qanday rasm yuklanmagan</p>
                  </div>
                )}
              </div>
              ...
              {isReadOnly && (
                <div className="border-t border-gray-200 pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                    <div>
                      <span className="font-medium text-gray-600">Ishchi:</span>
                      <p className="text-gray-900">{complaint.worker_name}</p>
                    </div>
                    
                    <div>
                      <span className="font-medium text-gray-600">Yaratilgan sana:</span>
